...
require_pattern "eaw-resource-manager start --daemon" README.md README.zh-CN.md docs/logic-analyzer-agent-skill.md docs/logic-analyzer-agent-skill.zh-CN.md packages/resource-manager/README.md packages/resource-manager/README.zh-CN.md
require_pattern "eaw-resource-manager status --json" README.md README.zh-CN.md docs/logic-analyzer-agent-skill.md docs/logic-analyzer-agent-skill.zh-CN.md packages/resource-manager/README.md packages/resource-manager/README.zh-CN.md
require_pattern "eaw-resource-manager stop" README.md README.zh-CN.md docs/logic-analyzer-agent-skill.md docs/logic-analyzer-agent-skill.zh-CN.md packages/resource-manager/README.md packages/resource-manager/README.zh-CN.md
